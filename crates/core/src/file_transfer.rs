...
mod tests {
    ...
    fn test_cid_to_string() {
        let cid = Cid {
            ...
            hash: [
                0xFF, 0xD2, 0x34, 0x1A, 0x00, 0xAB, 0xCD, 0xEF,
                0x00, 0x11, 0x33, 0x55, 0x77, 0x99, 0xBB, 0xDD,
                0xCC, 0xEE, 0x55, 0x66, 0x77, 0x88, 0x99, 0xAA,
    ...
    fn test_cid_from_str() {
        ...
        assert_eq!(cid.hash, expected_hash, "The hash part was incorrectly parsed");
    }
